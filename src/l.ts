module ProStyle.Extensions {
	...
	*/
	...
	var i, j, x2, y2,q:any=zeros(nmt+1)
	...
	var y=n.concat(), t, r, bq, a:any=[1], b:any=[0], ts
	a.sign=0; b.sign=0
	...
	export function c() {
		if (ProStyle["pl"]) return;

		var hn = window.location.hostname.trim().toLowerCase();
		if (hn === '' || hn === 'localhost' || hn === '127.0.0.1') return;
		ProStyle["hn"] = hn;
