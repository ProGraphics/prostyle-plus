...
a.push(new b.BarDataPropertyType)};d.get=function(){void 0===d._propertyTypes&&d.cacheProperties();return d._propertyTypes};d.getForBars=function(){void 0===d._barPropertyTypes&&d.cacheProperties();return d._barPropertyTypes};d._propertyTypes=void 0;d._barPropertyTypes=void 0;return d}();b.SimpleBarChartPropertyTypes=f})(b.SimpleBarChart||(b.SimpleBarChart={}))})(b.Items||(b.Items={}))})(c.Extensions||(c.Extensions={}))})(ProStyle||(ProStyle={}));
(function(c){(function(b){(function(b){(function(b){b.serialize=function(b){return{}}})(b.SimpleBarChart||(b.SimpleBarChart={}))})(b.Items||(b.Items={}))})(c.Extensions||(c.Extensions={}))})(ProStyle||(ProStyle={}));
...
2+b*(c.margin+c.barWidth),width:c.barWidth,y:k,height:d,rx:f,ry:f}})};return a}(c.Views.Items.ItemView);b.SimpleBarChartItemView=f})(b.SimpleBarChart||(b.SimpleBarChart={}))})(b.Items||(b.Items={}))})(c.Extensions||(c.Extensions={}))})(ProStyle||(ProStyle={}));
(function(c){(function(b){(function(b){(function(b){var e=function(c){function d(a,b,d,e,k,n,l,g,q,p,m){c.call(this,a,"simpleBarChart","SimpleBarChart",[g,p],[q,m]);this.bars=b;this.width=d;this.height=e;this.margin=k;this.minDomainValue=n;this.maxDomainValue=l;this.barsInit=p;this.barsScriptSet=m}__extends(d,c);d.prototype.serialize=function(){return b.serialize(this)};d.prototype.createView=function(a){return new b.SimpleBarChartItemView(this,a)};return d}(c.Models.Items.ItemModel);b.SimpleBarChartItemModel=
e})(b.SimpleBarChart||(b.SimpleBarChart={}))})(b.Items||(b.Items={}))})(c.Extensions||(c.Extensions={}))})(ProStyle||(ProStyle={}));
...
0);l<n&&(g=l,l=n,n=g);var q=b.SimpleBarChartPropertyTypes.get(),p=b.SimpleBarChartPropertyTypes.getForBars(),g=e.PropertyListReader.read(c.story,a.init,q),u=e.PropertyListReader.read(c.story,a.barInit||a.barsInit,p),q=e.ScriptSetReader.readJson(c,"Chart",a,[""],q),p=e.ScriptSetReader.readJson(c,"Bars",a,["bar","bars"],p);return new b.SimpleBarChartItemModel(c,m,r,t,h,n,l,g,q,u,p)}})(b.SimpleBarChart||(b.SimpleBarChart={}))})(b.Items||(b.Items={}))})(c.Extensions||(c.Extensions={}))})(ProStyle||(ProStyle=
{}));
